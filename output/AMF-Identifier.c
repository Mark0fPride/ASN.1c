...
int
AMF_Identifier_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
AMF_Identifier_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
AMF_Identifier_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	AMF_Identifier_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
AMF_Identifier_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
AMF_Identifier_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
AMF_Identifier_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
AMF_Identifier_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
AMF_Identifier_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_AMF_Identifier = {
	...
	"AMF-Identifier",
	AMF_Identifier_free,
	AMF_Identifier_print,
	AMF_Identifier_constraint,
	AMF_Identifier_decode_ber,
	AMF_Identifier_encode_der,
	AMF_Identifier_decode_xer,
	AMF_Identifier_encode_xer,
